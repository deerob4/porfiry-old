...
\subsubsection{Quiz Creation Screen}
\begin{figure}[h!]
...
\subsubsection{Countdown Screen}
\begin{figure}[h!]
...
\subsection{Input and Output Screens}
One screen, the actual quiz playing interface, will both allow users to input data - choosing the correct answer - and output data - displaying the quiz and the current live results.

\subsubsection{Play Quiz Screen}
\begin{figure}[h!]
