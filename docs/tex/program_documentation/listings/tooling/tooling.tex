...
\lstinputlisting[language=javascript, caption=Bootstraps the backend.]{../app/webpack.config.babel.js}
% subsubsection server_js (end)

\subsubsection{index.html} % (fold)
This file serves as an entry point for the client.
\lstinputlisting[language=html, caption=Main HTML entry.]{../app/client/index.html}
% subsubsection server_js (end)