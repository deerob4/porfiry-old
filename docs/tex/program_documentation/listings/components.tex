...
\subsubsection{AnswerBlock.js} % (fold)
\label{ssub:answerblock_js}
\lstinputlisting[language=javascript, caption=Component to answer the question.]{../src/components/play/AnswerBlock.js}
% subsubsection answerblock_js (end)
